                ...
                <form id="customOrderForm" class="text-sm">
                    ...
                    <div class="flex gap-4 mb-6 flex-wrap">
                        ...
                        <div class="flex-1 min-w-48 mb-4">
                            ...
                            <input type="text" id="co_nama" required placeholder="Masukkan nama (hanya huruf)" class="w-full p-2.5 border border-border-dark rounded-lg font-inherit outline-none focus:border-primary-brown">
                        </div>
