            ...
            <div class="flex-1 w-full">
                ...
                <div class="flex flex-col md:flex-row gap-4 mb-8 justify-between w-full lg:items-center">
                    ...
                    <div class="flex items-center border border-border-dark rounded-lg overflow-hidden w-full md:w-auto justify-center md:justify-start">
                        ...
                        <input type="number" id="qty" value="1" min="1" max="{{ $kue->stok }}" oninput="if(this.value !== ''){ if(parseInt(this.value) > parseInt(this.max)) this.value = this.max; if(parseInt(this.value) < 1) this.value = 1; }" class="w-10 h-12 text-center border-none text-lg outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none">
                        <button class="bg-white border-none py-3 px-4 cursor-pointer text-lg" onclick="changeQty(1)">+</button>
                    </div>
                </div>
